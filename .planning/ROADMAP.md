...
Plans:
- [ ] 03-01-PLAN.md — Embedding service (OpenAI client, get_embedding, build_job_text, build_profile_text, compute_ats_score, compute_skill_gaps)
...
- [ ] 03-06-PLAN.md — Match router (GET /api/v1/matches/, GET /api/v1/jobs/{id}/match, schemas)
